...
% Show an example of working backwards to parse the formula. 
    ...
    \section{First Order Logic}
        ...
        %          Mention that equality is well-defined wrt. predicates and functions.
...
\chapter{Computation}
    ...
    % Comment on Leibniz' goal of the computability of reason. 


    % Comment on Hilbert's dream. 
    ...
    % Write a paragraph about G\"{o}del codes and how to make propositions and proofs objects of computation. Reducing questions about the computability of proofs to computability of functions of the natural numbers. 

    % Comment on the many models of computation. 
    ...
    % Comment on the BHK definition of the connectives. 
